  ...
  return (
    <div className={`flex flex-col items-center gap-2`}>
      ...
      <div className={`relative z-50`}>
        <div
          className={`w-10 h-10 ${
            ste.id < step ? " bg-yellow-50 text-richblack-900" : ""
          } border text-lg ${
            step === ste.id
              ? "text-[#FFD60A] border-[#FFD60A] bg-[#251400] font-semibold"
              : "text-richblack-200 border-[#2C333F] bg-[#161D29]"
      ...
      {/* bottom */}
      <div
        className={`text-sm w-[50%] md:w-[100%] ${
          ste.id === step ? "text-richblack-25" : "text-[#585D69]"
        }`}
      >
        {ste.title}
      </div>
