...
import { editBloggerSubSection } from "../../../../service/apiCall/courseApiCall";
import { useDispatch, useSelector } from "react-redux";
import { FileUpload } from "../../../ui/file-upload";


function EditSubSectionModal({ editSubSectionModal, setEditSubSectionModal }) {
  ...
  async function submitHandler(e) {
    e.preventDefault();
    await editBloggerSubSection(editSubSectionModal.blogId,editSubSectionModal.subSectionId,body,files[0],token,dispatch);
      ...
      >
        ...
        <div className="flex flex-col gap-3 items-start w-full">
          ...
          <div className=" w-full">
            <label className=" text-richblack-25">Edit content of current topic/section if you need.</label>
            <textarea
        ...
        <div className="flex items-center gap-x-4">
          ...
          <button
            ...
            onClick={() => setEditSubSectionModal(null)}
          >
            Cancel
          </button>
        </div>
